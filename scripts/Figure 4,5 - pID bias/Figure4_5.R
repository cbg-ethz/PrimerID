    13195, 13256, 13317, 13379, 13441, 13503, 13565, 13628, 13691, 13754, 13818, 13882, 13946, 14011, 14076, 14141, 14206, 14272, 14338, 14404, 14471, 14538, 14605, 14672, 14740, 14808, 14877, 14946, 15015, 15084, 15154, 15224, 15295, 15365, 15436, 15508, 15579, 15652, 15724, 15797, 15870, 15943, 16017, 16091, 16165, 16240, 16315, 16391, 16466, 16543, 16619, 16696, 16773, 16851, 16929, 17007, 17086, 17165, 17244, 17324, 17404, 17484, 17565, 17647, 17728, 17810, 17893, 17975, 18058, 18142, 18226, 
    18310, 18395, 18480, 18565, 18651, 18738, 18824, 18911, 18999, 19087, 19175, 19264, 19353, 19442, 19532, 19622, 19713, 19804, 19896, 19988, 20080, 20173, 20267, 20360, 20454, 20549, 20644, 20740, 20836, 20932, 21029, 21126, 21224, 21322, 21420, 21520, 21619, 21719, 21819, 21920, 22022, 22124, 22226, 22329, 22432, 22536, 22640, 22745, 22850, 22956, 23062, 23168, 23276, 23383, 23491, 23600, 23709, 23819, 23929, 24040, 24151, 24263, 24375, 24488, 24601, 24715, 24829, 24944, 25059, 25175, 25291, 
    25408, 25526, 25644, 25763, 25882, 26001, 26122, 26242, 26364, 26486, 26608, 26731, 26855, 26979, 27104, 27229, 27355, 27482, 27609, 27737, 27865, 27994, 28123, 28253, 28384, 28515, 28647, 28780, 28913, 29046, 29181, 29316, 29451, 29588, 29724, 29862, 30000)
...
for (i in 1:6) {
    ...
    real_DATA[[i]] <- read.table(file = paste("../Analysis/", file, "_nucMask_2_pID_counts.csv", sep = ""), header = TRUE, sep = ",")
}
...
for (i in 1:6) {
    ...
    tmp_DATA <- real_DATA[[i]]$replicates[order(real_DATA[[i]]$replicates, decreasing = TRUE)]
...
for (i in 1:6) {
    ORDER_i <- order(real_DATA[[i]]$replicates, decreasing = TRUE)
    seqs_i <- as.vector(real_DATA[[i]]$Primer[ORDER_i[1:INTERSECT_CUTOFF]])
    
    UNION <- c()
    for (j in 1:6) {
        if (i != j) {
            ORDER_j <- order(real_DATA[[j]]$replicates, decreasing = TRUE)
...
for (i in 1:6) {
    file <- files[i]
    ORDER <- order(real_DATA[[i]]$replicates, decreasing = TRUE)
    message("Processing ", file)
    message("Optimal parameters: ", best_match[[i]])
    message("Rank 1  :", real_DATA[[i]]$replicates[ORDER[1]])
    message("Rank 100:", real_DATA[[i]]$replicates[ORDER[INTERSECT_CUTOFF]])
    message("Range   :", real_DATA[[i]]$replicates[ORDER[1]] - real_DATA[[i]]$replicates[ORDER[INTERSECT_CUTOFF]])
...
VENN_ALL <- venn.diagram(SEQUENCES_ALL, filename = NULL, euler.d = FALSE, scaled = FALSE, fill = colours[1:5], alpha = rep(ALPHA, 5), cex = CEX.LAB5, cat.cex = CEX.CLASS, cat.dist = c(0.18, 0.23, 0.18, 0.2, 0.22))
grid.draw(VENN_ALL)
